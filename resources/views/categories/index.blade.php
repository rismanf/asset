    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('Categories Management') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @can('category-create')
                        <p><a class="btn btn-success" href="{{ route('categories.create') }}"> Create New Categories</a></p>
                    @endcan
        ...
        $(function() {
            ...
            $('body').on('click', '.deletebtn', function() {
                ...
                if (confirm("Are you sure want to delete?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('categories.store') }}" + '/' + site_id,
            ...
            $('body').on('click', '.forcedeletebtn', function() {
                ...
                if (confirm("Are you sure want to permanently delete?")) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('categories.forcedelete') }}",
                        data: {
                            "id": id,
                        },
                        success: function(data) {

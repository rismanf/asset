                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('category_group_id', $group, $category_group, array('class' => 'select2 form-control')) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Body" class="form-control" name="body" cols="50" rows="10">{{ old('description', $category->description) }}</textarea>

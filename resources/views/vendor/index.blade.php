    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('Vendor Management') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @can('vendor-create')
                        <p><a class="btn btn-success" href="{{ route('vendor.create') }}"> Create New Vendor</a></p>
                    @endcan
        ...
        $(function() {
            ...
            $('body').on('click', '.deletebtn', function() {
                ...
                if (confirm("Are you sure want to delete?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('vendor.store') }}" + '/' + site_id,

                    ...
                    @can('asset-create')
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="form-group">
                                    <strong>Site:</strong>
                                    <select id="site" class="select2 form-control" name="site_id" data-placeholder="Category Group"
                                        style="width: 100%;">
                                        <option value="">-- Choose --</option>
                                        @foreach ($site as $id => $item)
                                            <option value="{{ $id }}"
                                                {{ old('site_id') == $id ? 'selected' : '' }}>{{ $item }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <strong>Room:</strong>
                                    <select id="room" class="select2 form-control" name="room_id" data-placeholder="room"
                                        style="width: 100%;">
                                    </select>

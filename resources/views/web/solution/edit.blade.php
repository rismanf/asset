            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('Edit Web Solution') }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('Edit Web Solution') }}</h3>
            ...
            <div class="card-body">
                {!! Form::model($solution, ['method' => 'PATCH','route' => ['websolution.update', $solution->id]]) !!}
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$solution->text}}</textarea>
                            @if ($errors->has('text'))

                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('room.index') }}">{{ __('Room Management') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('Add New Room') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Add New Room') }}</h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="site" class="select2 form-control" name="site_id" data-placeholder="Site"
                                        ...
                                        @foreach ($site as $id => $item)
                                            <option value="{{ $id }}" {{ old('site_id') == $id ? "selected" :""}}>{{ $item }}</option>
                                        @endforeach
                                    </select>
